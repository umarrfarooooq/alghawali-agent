    ...
    <>
        <div className='bg-[#253061] text-[#FFFBFA]'>
            <div className='flex items-center justify-between container p-4'>
                ...
                <div><span className='text-3xl font-semibold hidden sm:inline-block'>{t('title')}</span></div>
                <div><LanguagePicker /></div>

            </div>
            <div><span className='text-xl text-center font-semibold inline-block sm:hidden container pb-4'>{t('title')}</span></div>
        </div>
    </>
  )
}
